...
data_dir = os.getenv("SLURM_TMPDIR") + "/mnt/ramdisk/max/90kDICT32px/"
...
## LMDB file  ##
########################
filename = "lmdb-numpy-all.lmdb"
if os.path.exists(filename): shutil.rmtree(filename)
env = lmdb.open(filename, map_size=int(200e9))

########################
## Meta info file  ##
########################

filename = "lmdb-numpy-all.sqlite"
